...
{    IdEmpleado = 1,    Nombre = "Michael Delgado",    Puesto = "Gerente TI"};

Desarrollador desarrollador = new Desarrollador
{    IdEmpleado = 2,    Nombre = "Jonathan Delgado",    Puesto = "Desarrollador"};

GerenteRRHH gerenteRRHH = new GerenteRRHH
{    IdEmpleado = 3,    Nombre = "Guillermo Delgado",    Puesto = "Gerente RRHH"};

ConsultorExterno consultorExterno= new ConsultorExterno
{ IdEmpleado = 4, Nombre = "Margarita Torres", Puesto = "Consultor Externo" };
